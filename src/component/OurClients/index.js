...
import imgkemhan from '../../images/brand/logokemhan.png'
import imgtni from '../../images/brand/logotni.png'
        ...
        <ContentWrapper id={'ourclients'}>
            ...
            <RowWrapper >
                <Grid container spacing={2} style={{margin:'auto', marginBottom:'10%', marginTop:'5%', maxWidth:'90%'}} id="ourpartner">
                        <Grid item xs={12}>
                        <TitleShadow style={{color:'#707070', marginBottom:`${mobile?'5vh' : '14vh'}`}}>Our Clients</TitleShadow> 
                            </Grid>
                            <Grid item xs={12} sm={6} md={4}style={{display:'flex', flexDirection:'column', justifyContent:'center'}}>
                          <GridContent pic={imgkemhan}/>
                          </Grid>
                          <Grid item xs={12} sm={6} md={4}style={{display:'flex', flexDirection:'column', justifyContent:'center'}}>
                          <GridContent pic={imgtni}/>
                          </Grid>
                        <Grid item xs={12} sm={6} md={4}style={{display:'flex', flexDirection:'column', justifyContent:'center'}}>
