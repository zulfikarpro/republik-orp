...
const OurWorksPage = ({mobile}) => {
    ...
    return ( 
        <Container style={{background:`url(${background})`, backgroundSize: `${mobile?'100vh':'100vw'}`, backgroundPosition:`${mobile?'30% -0px':''}`,backgroundRepeat:'no-repeat', height:'100vh'}} id='ourworks'>
            <ContentDiv>
                <div style={{width:'100%', height:'100%', display:'flex', flexDirection:`${mobile?'column':'row'}`, justifyContent:`${mobile?'center':'flex-end'}`, background:`${mobile?'rgba(10,15,62,.6)':''}`}}>
                    <div style={{width:`${mobile?'100%':'40%'}`,height:`${mobile?'100vh':'100vh'}`, background:`${mobile?'':''}`,  display:'flex', flexDirection:'column', justifyContent:'center', color:'white', maxWidth:'100vw'}}>
                        <H1 style={{margin:`${mobile?'':''}`, marginLeft:`${mobile?'auto':''}`, marginRight:`${mobile?'auto':''}`, marginBottom:'2px', marginTop:`${mobile?'30px':''}`}}>Our Works</H1>
                        <P style={{maxWidth:'80%', margin:`${mobile?'auto':''}`, marginBottom:`${mobile?'30px':''}`, marginTop:`${mobile? '0px': ''}`}}>
