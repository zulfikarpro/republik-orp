...
const OurWorksPage = ({mobile}) => {
    ...
    return ( 
        <Container style={{background:`url(${background})`, backgroundSize: `${mobile?'80vh':'100vw'}`, backgroundRepeat:'no-repeat', height:'100vh'}} id='ourworks'>
            <ContentDiv>
                <div style={{width:'100%', height:'100%', display:'flex', flexDirection:`${mobile?'column':'row'}`, justifyContent:`${mobile?'center':'flex-end'}`}}>
                    <div style={{width:`${mobile?'100%':'40%'}`,height:`${mobile?'auto':'100vh'}`, background:`${mobile?'rgba(0,0,0,.8)':''}`,  display:'flex', flexDirection:'column', justifyContent:'center', color:'white', maxWidth:'100vw'}}>
                        <H1 style={{margin:`${mobile?'auto':''}`, marginBottom:'20px', marginTop:'40px'}}>Our Works</H1>
                        <div style={{height:'2px', width:'40%', margin:`${mobile?'auto':''}`, marginBottom:'20px', background:'white'}}/>
                        <P style={{maxWidth:'70%', margin:`${mobile?'auto':''}`, marginBottom:'10vh'}}>
