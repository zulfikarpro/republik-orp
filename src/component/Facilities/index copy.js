...
const FacilitiesPage = () => {
    return (
        ...
        <Container style={{minHeight:'200vh', minWidth:'100%',height:'auto', marginTop:'0px', justifyContent:'flex-start'}}>
        <ContentDiv style={{minWidth:'100%', justifyContent:'flex-start'}} id='facilities'>
