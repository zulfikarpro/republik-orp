...
//     // if(mobile){
//     return (
//            <Container style={{overflowX:'hidden', maxWidth:'100%', minHeight:'100%', minWidth:`${mobile?'':'100%'}`, marginTop:'0px', justifyContent:'flex-start'}}>
//              <ContentDiv style={{minWidth:'100%', minHeight:'100%',height:'200vh', justifyContent:'flex-start'}} >
//                <img style={{zIndex:-1 ,height:'100%', maxWidth:'100vw', objectFit:'cover'}} src={bg}/>
//                 <div style={{position:'absolute', width:'100vw', height:'100%', display:'flex', flexDirection:'row', justifyContent:'center'}}  id="ourpartner">
//                   <div style={{display:'flex', flexDirection:'column', color:'#fff',justifyContent:'flex-start', height:'200%' , padding:'0px'}}>
//                     <div style={{width:'100vw', textAlign:'center', zIndex:'-1', marginTop:`${mobile? '0px': '15vh' }`, marginBottom:`${mobile? '0px': '10vh' }`}}>
//                       <Title style={{maxWidth:'100vw', marginBottom:'0px'}}>Our Partners</Title>
//                     </div>
//                     <div style={{width:'100%', display:'flex', flexDirection:'row', justifyContent:'flex-start', height:'20%', marginTop:'0px'}} >
//                       <Grid container spacing={0} style={{maxWidth:'80vw'}}>
//                         <Grid item xs={12} md={12}>
//                             <div style={{width:'100%', maxWidth:`${mobile?'':'500px'}`, margin:'auto', marginTop:`${mobile?'20px':''}`, display:'flex', flexDirection:'row', justifyContent:'center'}}>
//                             <Img src={brand1}/>
//                             </div>
//                           </Grid>
//                         <Grid item xs={12} md={12}>
