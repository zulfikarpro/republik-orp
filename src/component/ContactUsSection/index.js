...
const ContactUsSection = ({mobile}
    ...
    return (
      <div id='contactus'style={{display:'flex', flexDirection:'column', justifyContent:'flex-end',backgroundImage:`url(${Background})`, backgroundRepeat:'no-repeat', backgroundSize:'cover',minHeight:'100vh', height:'100%', width:'100%', maxWidth:'100vw'}}>
      <div style={{display:'flex', flexDirection:'row', justifyContent:'center', color:'white', textAlign:'center', width:'90%', margin:'auto', maxWidth:'100vw'}}>
        <Grid container spacing={2} style={{margin:'auto',marginTop:'80px', width:'100%', maxWidth:'100vw'}}>
          ...
          <Grid item xs={12}md={6} style={{display:'flex', flexDirection:'row', justifyContent:'center'}}>
          <div style={{display:'flex', flexDirection:'column', minWidth:`${mobile?'':'400px'}`, maxWidth:'90%', margin:'auto', justifyContent:'center'}}>
            <div style={{marginRight:'auto', maxWidth:'90vw'}}>
